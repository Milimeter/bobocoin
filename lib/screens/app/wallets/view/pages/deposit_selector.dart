...
class DepositSelector extends StatefulWidget {
  const DepositSelector({Key? key}) : super(key: key);

  @override
  State<DepositSelector> createState() => _DepositSelectorState();
}

class _DepositSelectorState extends State<DepositSelector> {
                  ...
                  child: filteredCryptoAssets.isNotEmpty
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) => GestureDetector(
                            onTap: () {
                              Get.toNamed(Routes.RECEIVE_CRYPTO, arguments: {
