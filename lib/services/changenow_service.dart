...
String baseUrl = 'https://api.changenow.io/v1/';
String apiKey =
    '8de28357d14966dff6245c2539ec2e1add41d00f472d1fa6cbf0a8304327a5c5';

class ChangeNowApiService {
  ...
  static Future<List> getListData(String url) async {
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
    };
    try {
      ...
      log(link.toString());
      http.Response response = await http.get(link, headers: requestHeaders);
      //log("listdata: ${response.body}");
      List listData = List.from(json.decode(response.body) as List);
